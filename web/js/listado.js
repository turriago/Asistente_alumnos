...
async function load() {
  ...
  try {
    ...
    if (labelMissing) labelMissing.textContent = "No fueron";
    ...
    if (presentHeading) presentHeading.textContent = "Presentes";
    if (missingHeading) missingHeading.textContent = "No asistieron";
    if (total) {
